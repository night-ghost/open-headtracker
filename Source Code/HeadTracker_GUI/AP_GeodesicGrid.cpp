...
const Matrix3f AP_GeodesicGrid::_inverses[10]={
    Matrix3f(-0.309017f,  0.500000f,  0.190983f,
      0.000000f,  0.000000f, -0.618034f,
     -0.309017f, -0.500000f,  0.190983f),

	Matrix3f(-0.190983f,  0.309017f, -0.500000f,
     -0.500000f, -0.190983f,  0.309017f,
      0.309017f, -0.500000f, -0.190983f),
    
	Matrix3f(-0.618034f,  0.000000f,  0.000000f,
      0.190983f, -0.309017f, -0.500000f,
      0.190983f, -0.309017f,  0.500000f),

    Matrix3f(-0.500000f,  0.190983f, -0.309017f,
...
const Matrix3f AP_GeodesicGrid::_mid_inverses[10]={
    Matrix3f(-0.000000f,  1.000000f, -0.618034f,
      0.000000f, -1.000000f, -0.618034f,
     -0.618034f,  0.000000f,  1.000000f),
    Matrix3f(-1.000000f,  0.618034f, -0.000000f,
     -0.000000f, -1.000000f,  0.618034f,
      0.618034f, -0.000000f, -1.000000f),
    Matrix3f(-0.618034f, -0.000000f, -1.000000f,
                                             ...
                                             bool inclusive)
{
    ...
    if (is_equal(u.x, u.y)) {
		...
		const struct neighbor_umbrella &uu=_neighbor_umbrellas[idx % 3];

        double x0 = w[uu.v0_c0];
        if (is_zero(x0)) {
            if (!inclusive) {
                return -1;
            }
    ...
    if (u.y > u.x) {
        ...
        double x1 = w[_neighbor_umbrellas[idx % 3].v1_c1];
        double x2 = w[_neighbor_umbrellas[idx % 3].v2_c1];
        ...
        double x4 = w[_neighbor_umbrellas[idx % 3].v4_c4];
        double x0 = w[_neighbor_umbrellas[idx % 3].v0_c4];
