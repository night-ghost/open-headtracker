...
#define MPU6050_TIMER1INIT TCCR1A |=(1<<CS02)|(1<<CS00); \
		TIMSK1 |=(1<<TOIE0);

#define MPU6050_TIMER2INIT TCCR2B |=(1<<CS02)|(1<<CS00); \
		TIMSK2 |=(1<<TOIE0);
...
#endif
extern void imu10dof01_updateQuaternion();
extern void imu10dof01_mahonyUpdate(float gx, float gy, float gz, float ax, float ay, float az, float mx, float my, float mz);
