        ...
        if (string_started == 1)  {
           ...
           Serial.write(serial_data[serial_index-1]);
                ...
                serial_data[serial_index-1] == 'H' )
            {
                ...
                Serial.print(PSTR("Channel mapping received\n"));
            ...
            // Configure headtracker
                ...
                Serial.print(PSTR("HT config received:\n"));
            ...
            {
                Serial.print(PSTR("FW: %S"));
                Serial.print(FIRMWARE_VERSION_FLOAT);
                serial_index = 0;
                string_started = 0; 
            }
...
//              SaveSettings();
		...
		Serial.print(PSTR("Gyro offset measured: "));
...
//		Serial.printf_P(PSTR("Acc offset stored %d,%d,%d\n"),  accOffset[0], accOffset[1], accOffset[2]);
                     ...
                     serial_data[serial_index-1] == 'T' )
            {
                ...
                //
                Serial.print(PSTR("$SET$")); // something recognizable in the stream
		...
		char c=',';
                ...
                Serial.print(PSTR("Settings Retrieved!\n"));
...
{  
    ...
    Serial.print(PSTR("Settings saved!\n"));
}
...
void SaveMagData()
{
    ...
    Serial.print(PSTR("Mag offset saved!\n"));
...
void SaveAccelData()
{
    ...
    Serial.print(PSTR("Acc offset saved!\n"));
