...
*/
void FastSerial::begin(long baud, uint8_t *rxBuf, unsigned int rxMask, uint8_t *txBuf, unsigned int txMask)
{
	uint16_t ubrr;
	bool use_u2x = true;
...
byte FastSerial::available(void)
{
	if (!_open)
		return (-1);
